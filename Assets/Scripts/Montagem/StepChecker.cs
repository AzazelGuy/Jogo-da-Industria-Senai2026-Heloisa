...
/// <summary>
/// Informações de uma peça requerida para a montagem, configurável no Inspector.
/// </summary>
[System.Serializable]
...
/// <summary>
/// Controla o progresso geral da montagem: registra peças colocadas, valida se
/// a montagem foi concluída (considerando também os parafusos/conectores de cada peça)
/// e dispara os eventos correspondentes para a UI/lógica do jogo.
/// </summary>
public class StepChecker : MonoBehaviour
{
    ...
    #region Validação de Montagem

    /// <summary>
    /// Verifica se todas as peças da lista (ou da cena) foram encaixadas E se seus parafusos
    /// foram concluídos.
    /// </summary>
    ...
    /// <summary>
    /// Avalia o progresso de parafusos/conectores de um encaixe específico e,
    /// caso todos estejam concluídos, verifica se a montagem inteira foi finalizada.
    /// </summary>
